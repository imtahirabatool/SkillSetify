...
export default function PricingSection() {
  ...
  return (
    <section
      className="w-full px-4 py-8 bg-gray-50"
      style={{
        paddingBottom: "100px",
      }}
    >
      <Typography
        variant="h4"
        className="mb-5 text-center font-bold text-[#008080]"
      >
        Choose Your Plan
      </Typography>
      <br />
      <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8 mx-auto max-w-7xl px-4">
        {/* Basic Plan */}
        <Card className="bg-gradient-to-b from-teal-600 to-white text-white shadow-lg text-center">
          <CardContent>
        ...
        {/* Pro Plan */}
        <Card className="bg-gradient-to-b from-teal-600 to-white text-white text-center shadow-lg">
          <CardContent>
            <Typography variant="h5" component="div" gutterBottom>
              Pro
            </Typography>
